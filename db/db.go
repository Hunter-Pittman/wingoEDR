...
func DbInit() {
	...
	create table if not exists currentautoruns (type text not null primary key, location text, image_path text, image_name text, arguments text, md5 text, sha1 text, sha256 text);
